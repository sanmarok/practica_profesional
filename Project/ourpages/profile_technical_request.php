...
<body class="layout-navbar-fixed control-sidebar-slide-open dark-mode">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <?php include '../ourwidgets/profile_technical/form_edit_technical_request.php'; ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#editTech").click(function() {
                enableEdit("inputTech");
            });

            $("#editCaseType").click(function() {
                enableEdit("inputCaseType");
            });

            $("#editTechStatus").click(function() {
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#inputIDservice, #inputProblem, #inputTech, #inputCaseType, #inputTechStatus").on("change", function() {
