...
<body class="layout-navbar-fixed control-sidebar-slide-open dark-mode">
    ...
    <div class="wrapper">
        ...
        <?php include '../ourwidgets/product_details/dashboard_parts.php' ?>
        <!--End dashboard parts-->
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <?php include '../ourwidgets/product_details/form_edit_product.php'; ?>
                            <!--End form_edit_order-->
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#inputDescription, #inputName, #inputUnit, #inputStock, #inputCost").on("change", function () {
